                      ...
                      child: Column(
                        children: [
                          _selectedTypeNotifications == 2
                            ...
                            width: sharedPrefController.language =='en' ? 60.w : 60.w,
                            height: 5.h,
                          )
                              : SizedBox(height: 5.h),
                          SizedBox(height: 20.h),
                      ...
                      child: Column(
                        ...
                        children: [
                          _selectedTypeNotifications == 3
                            ...
                            width: sharedPrefController.language =='en' ? 66.w : 83.w,
                            height: 5.h,
                          )
                              : SizedBox(height: 4.h),
                          SizedBox(height: 20.h),
                          Text(
                            AppLocalizations.of(context)!.mentions,
                            style: TextStyle(
                                fontSize: 13.sp,
                    ...
                    isEmpty ? InkWell(
                      child: Column(
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(context)!.thereAreNoNotificationYet,
                            style: TextStyle(
                                fontSize: 17.sp,
                                color: HexColor('#333333'),
                                fontFamily: 'BreeSerif'),
                          ...
                          SizedBox(height: 8.h),
                          Text(
                            AppLocalizations.of(context)!.anyNewNotificationsWillAppearHere,
                            style: TextStyle(
                                fontSize: 12.sp,
                                color: HexColor('#333333'),
                                fontFamily: 'BreeSerif'),
